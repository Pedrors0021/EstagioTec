...
if (isset($_SESSION['cnpj'])) {
	...
	$stmt = "SELECT * FROM cadastroempresa WHERE cnpj = '" . $_SESSION['cnpj'] . "';";
...
<div class="about">
    ...
    <form method="get" action="editarsobreempresa.php">
...
<br><br><br>
    ...
    <span id="cnpj"><?php echo $registro['cnpj']; ?></span>
</div><br><br>
...
<br><br><br><br>
    ...
    <center> <form id="profile-form" action="upload_profile_empresa.php" method="post" enctype="multipart/form-data">
